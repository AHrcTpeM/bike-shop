...
import { Flex, Title, Text, Button } from 'components/ui';
...
function Form() {
    ...
    return (
        <BorderContainer>
            ...
            {selectedTab === 1 && (
                <Flex padding='60px 80px' direction='column'>
                    <Text alignSelf='flex-start' margin='30px 0 100px'>Введите номер заказа, что бы узнать о его статусе:</Text>
